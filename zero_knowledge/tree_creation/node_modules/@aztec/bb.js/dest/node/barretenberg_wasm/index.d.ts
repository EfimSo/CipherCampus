...
import { BarretenbergWasmMain, BarretenbergWasmMainWorker } from '../../../src/barretenberg_wasm/barretenberg_wasm_main/index.js';
export declare function fetchModuleAndThreads(desiredThreads?: number, wasmPath?: string, logger?: (msg: string) => void): Promise<{
...
export declare class BarretenbergWasm extends BarretenbergWasmMain {
     ...
     */
    static new(desiredThreads?: number, wasmPath?: string, logger?: (msg: string) => void): Promise<{

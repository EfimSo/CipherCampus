import { BarretenbergApi, BarretenbergApiSync } from '../../../src/barretenberg_api/index.js';
export { BarretenbergVerifier } from '../../../src/barretenberg/verifier.js';
export { UltraPlonkBackend, UltraHonkBackend, AztecClientBackend } from '../../../src/barretenberg/backend.js';
...
export declare class BarretenbergSync extends BarretenbergApiSync {
    ...
    getWasm(): import("../../../src/barretenberg_wasm/index.js").BarretenbergWasm;
}
